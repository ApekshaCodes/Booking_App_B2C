...
"[project]/.next-internal/server/app/api/seed/bookings/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/seed/bookings/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$user$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(); // get all users
        if (users.length === 0) {
        ...
        const inserted = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].insertMany(fakeBookings);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Bookings seeded',
            inserted
        });
    } catch (error) {
        console.error('❌ Seeding error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Failed to seed bookings'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6c58fd0f._.js.map