...
async function GET(req) {
    try {
        ...
        const condition = status === 'upcoming' ? {
            last_travel_date: {
                $gte: today
            }
        } : {
        ...
        const bookings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            userId,
            ...condition
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__717c3b7e._.js.map